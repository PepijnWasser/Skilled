...
public class UpdateRigidbodyPositionResponse : USerializable
{
    ...
    public UpdateRigidbodyPositionResponse()
    {

    }

    public UpdateRigidbodyPositionResponse(int _ID, Vector3 _playerPosition, Vector3 _playerRotation)
    {
